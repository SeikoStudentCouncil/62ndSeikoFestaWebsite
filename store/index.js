  ...
  return new Vuex.Store({
    state: () => ({
      ...
      departments: [
        ...
        {num: "03",name: "管理部門", name_alphabet: "The Department of Food", img_name:"displays", body:"食品部門は食品店舗を統括し、補佐する部門です。聖光祭の要とも言える食品店舗を統括し、よりよい味と最高のおもてなしを提供できるよう、何回も試作を繰り返し追求します。焼きそばや餃子などの王道店舗からポップコーンやドリンクなどのちょっとした食品までぜひどうぞ！"},
      ]
    }),
  })
}
